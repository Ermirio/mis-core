...
# CORS Config — ALLOW_ANY_ORIGIN é o toggle único; CORS_ALLOW_ALL_ORIGINS mantido por compat
CORS_ALLOW_ALL = (
    config('ALLOW_ANY_ORIGIN', default=False, cast=bool)
    or config('CORS_ALLOW_ALL_ORIGINS', default=False, cast=bool)
)
