...
// Flask-out completo: tudo via DJANGO_API_URL.
    ...
    useEffect(() => {
        const fetchLineHistory = async () => {
            ...
            try {
                ...
                const response = await fetch(`${DJANGO_API_URL}/linha/${equipamento.linha_nome}/historico?${params.toString()}`);
                if (response.ok) {
        ...
        const fetchSensorLimits = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    results
                        // Defesa em profundidade: a API ja filtra ativo=true,
                        // mas se o backend antigo ainda estiver no ar, ignoramos
                        // explicitamente sensores marcados como inativos.
