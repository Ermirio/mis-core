...
// Flask-out Onda 1: /health migrado para Django.
// Removida a checagem dedicada de "Flask API" - vai sair do ar no cutover.
...
export default function SystemStatus() {
  ...
  const checkAllServices = async () => {
    const djangoStatus = await checkServiceHealth(`${DJANGO_API_URL}/health`, 'Django API');
    setServices([djangoStatus]);
  };
