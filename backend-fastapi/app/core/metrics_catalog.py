...
METRICS: dict[str, MetricDef] = {
    ...
    # --- Gauges (GAUGE → MEAN) ---
    "refugo_turno_acumulado": MetricDef(
        name="refugo_turno_acumulado",
        influx_field="refugo_turno_acumulado",
        kind=MetricKind.COUNTER,
        default_agg=AggregationKind.DELTA,
        unit="un",
        description="Refugo acumulado no turno atual pelo contador OPC/PLC",
        aliases=("descarte_turno", "descarte_turno_acumulado", "pecas_ruins_turno"),
    ),
    "producao_turno_acumulada": MetricDef(
        name="producao_turno_acumulada",
        influx_field="producao_turno_acumulada",
        kind=MetricKind.COUNTER,
        default_agg=AggregationKind.DELTA,
        unit="un",
        description="Producao acumulada no turno atual pelo contador OPC/PLC",
        aliases=("produzido_turno", "pecas_boas_turno"),
    ),
