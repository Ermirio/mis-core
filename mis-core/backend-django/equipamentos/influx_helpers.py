...
def get_count_1min_ago(equipamento_codigo: str, client: Optional[InfluxDBClient] = None) -> float:
    """
    ...
    return get_current_count(equipamento_codigo, client)
...
def get_realtime_metrics(equipamento_codigo: str, formato_gramas: float,
                         inicio_turno: datetime) -> Dict[str, Any]:
    """
