...
class ApiClient {
  ...
  async calculateControlRecommendations(data) {
    return this.request('/control/recommendations/calculate', {
      method: 'POST',
      body: JSON.stringify(data),
    })
  }

  async applyControlRecommendation(recommendationId) {
    return this.request(`/control/recommendations/${recommendationId}/apply`, {
      method: 'POST',
    })
  }

  async getActiveControlRecommendations() {
    return this.request('/control/recommendations/active')
  }

  async getControlRecommendationsHistory(params = {}) {
    const queryParams = new URLSearchParams(params)
    return this.request(`/control/recommendations/history?${queryParams.toString()}`)
  }

  async getAllControlRecommendations(params = {}) {
    const queryParams = new URLSearchParams(params)
    return this.request(`/control/recommendations?${queryParams.toString()}`)
  }

  // ==================== REFERENCE SYNC ====================
  async getReferenceSyncStatus() {
    return this.request('/reference/sync/status')
  }

  async getAutoGeneratedData(params = {}) {
    const queryParams = new URLSearchParams(params)
    return this.request(`/data/auto-generated?${queryParams.toString()}`)
  }
